...
Iinp = G3_Laplace_Equation_Axb(I, mask, param);
figure(2)
imshow(Iinp)
title('After');
...
Iinp(:,:,1) = G3_Laplace_Equation_Axb(I(:,:,1), mask(:,:,1), param);
Iinp(:,:,2) = G3_Laplace_Equation_Axb(I(:,:,2), mask(:,:,2), param);
Iinp(:,:,3) = G3_Laplace_Equation_Axb(I(:,:,3), mask(:,:,3), param);
...
Iinp(:,:,1) = G3_Laplace_Equation_Axb(I_ch1, mask, param);
Iinp(:,:,2) = G3_Laplace_Equation_Axb(I_ch2, mask, param);
Iinp(:,:,3) = G3_Laplace_Equation_Axb(I_ch3, mask, param);
